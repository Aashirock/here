...
import com.spaceappschallenge.weatheronmars.helper.ParserWeatherReport;
...
public class WeatherReport {
	...
	public static WeatherReport parseXML(Context context) throws ParserConfigurationException, SAXException, IOException{
		String FILE_PATH = context.getFilesDir().getAbsolutePath() + "/"
				+ FILE_NAME;
		
		SAXParserFactory factory = SAXParserFactory.newInstance();
		SAXParser parser = factory.newSAXParser();
		ParserWeatherReport handler = new ParserWeatherReport();
